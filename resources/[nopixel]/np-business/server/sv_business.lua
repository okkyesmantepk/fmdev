...
RPC.register("np-business:hasPermission", function(pSource, pBusinessId)
    local hasPermission
    local user = exports["np-base"]:getModule("Player"):GetUser(pSource)
    local char = user:getCurrentCharacter()
    local tableh = {}
...
RPC.register("np-business:business:createRole", function(pSource, pBusinessId, pRoleName, pPermHire, pPermFire, pPermChangeRoles, pPermKeys, pPermStash, pPermCraft, pPermCharge, pPermBank, pPermLogs)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
    local user = exports['np-base']:getModule("Player"):GetUser(pSource)
...
RPC.register("np-business:phone:createRole", function(pSource, pBusinessId, pRoleName, pPermFire, pPermHire, pPermChangeRoles, pPermKeys, pPermStash, pPermCraft, pPermCharge, pPermBank, pPermLogs)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
...
RPC.register("np-business:business:editRole", function(pSource, pBusinessId, pCurRole, pRoleName, pPermFire, pPermHire, pPermChangeRoles, pPermKeys, pPermStash, pPermCraft, pPermCharge, pPermBank, pPermLogs)
...
RPC.register("np-businesses:getRoleAndEmployeesList", function(pSource, pBID)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBID
    }))
    local employees = json.decode(data[1].employees) or {}
...
RPC.register("np-business:business:GetEmploymentInformationBusinessID:Full", function(pSource, pBusinessId)
    local data = Await(SQL.execute("SELECT * FROM businesses WHERE business_id = @business_id", {
        ["business_id"] = pBusinessId
    }))
    local luckylucky = {}

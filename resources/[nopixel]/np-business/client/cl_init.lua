Citizen.CreateThread(function()
  -- quickfix
  exports["np-polyzone"]:AddBoxZone("business_stash", vector3(952.2, -115.63, 75.0), 1.8, 2.4, {
    heading = 314,
    minZ = 74.0,
    maxZ = 76.4,
    data = {
  ...
  exports["np-polyzone"]:AddBoxZone("business_craft", vector3(963.63, -103.55, 74.36), 1.8, 2.4, {
    heading = 44,
    minZ = 73.36,
    maxZ = 75.76,
    data = {

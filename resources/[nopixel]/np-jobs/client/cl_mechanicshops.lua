...
AddEventHandler('np-polyzone:enter', function(name)
    if name == "ottos_autos_craft" then
        ...
        OttosCraft()
        local isEmployed = exports["np-business"]:IsEmployedAt("ottos_autos")
        if isEmployed then
            exports['np-interface']:showInteraction("[E] Craft")
        end
...
Citizen.CreateThread(function()
    -- Tuner Shop | Start --
    exports["np-polyzone"]:AddBoxZone("tuner_shop_stash", vector3(128.46, -3014.08, 7.04), 2.5, 2.5, {
    ...
    exports["np-polyzone"]:AddBoxZone("tuner_shop_craft", vector3(143.96, -3051.26, 7.04), 1, 5, {
    ...
    exports["np-polyzone"]:AddBoxZone("harmony_repairs_stash", vector3(1187.12, 2635.81, 38.4), 1, 1.4, {
    ...
    exports["np-polyzone"]:AddBoxZone("harmony_repairs_craft", vector3(1176.23, 2635.29, 37.75), 3, 2, {
    ...
    -- Hayes Autos | Start --
    exports["np-polyzone"]:AddBoxZone("hayes_autos_stash", vector3(-1418.49, -454.77, 35.91), 1, 3.0, {
    ...
    exports["np-polyzone"]:AddBoxZone("hayes_autos_craft", vector3(-1408.17, -447.34, 35.91), 1, 5.0, {
    ...
    -- Ottos Autos | Start --
    exports["np-polyzone"]:AddBoxZone("ottos_autos_stash", vector3(837.15, -814.76, 26.33), 2, 3.0, {
    ...
    exports["np-polyzone"]:AddBoxZone("ottos_autos_craft", vector3(840.33, -827.5, 26.33), 2, 3.6, {

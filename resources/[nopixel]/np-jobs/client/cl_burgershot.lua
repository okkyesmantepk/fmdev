...
RegisterNetEvent("np-burgershot:soft-drink")
AddEventHandler("np-burgershot:soft-drink", function()
    local isEmployed = exports["np-business"]:IsEmployedAt("burger_shot")
    if isEmployed then   
...
RegisterNetEvent('np-burgershot:counter')
AddEventHandler('np-burgershot:counter', function()
    local isEmployed = exports["np-business"]:IsEmployedAt("burger_shot")
    if isEmployed then
...
RegisterNetEvent('np-burgershot:store')
AddEventHandler('np-burgershot:store', function()
    local isEmployed = exports["np-business"]:IsEmployedAt("burger_shot")
    if isEmployed then
...
RegisterNetEvent('np-civjobs:burgershot-heartstopper')
AddEventHandler('np-civjobs:burgershot-heartstopper', function()
...
RegisterNetEvent('np-civjobs:burgershot-moneyshot')
AddEventHandler('np-civjobs:burgershot-moneyshot', function()
    local ped = PlayerPedId()
    local isEmployed = exports["np-business"]:IsEmployedAt("burger_shot")
    if isEmployed then
...
RegisterNetEvent('np-civjobs:burgershot-meatfree')
AddEventHandler('np-civjobs:burgershot-meatfree', function()
    local ped = PlayerPedId()
    local isEmployed = exports["np-business"]:IsEmployedAt("burger_shot")
    if isEmployed then
...
RegisterNetEvent('np-civjobs:burgershot-bleeder')
AddEventHandler('np-civjobs:burgershot-bleeder', function()
    local ped = PlayerPedId()
    local isEmployed = exports["np-business"]:IsEmployedAt("burger_shot")
    if isEmployed then
...
RegisterInterfaceCallback('np-burgershot:cm', function(data, cb)
    cb({ data = {}, meta = { ok = true, message = '' } })
    TriggerEvent('np-burgershot:contains-meat')
end)

RegisterInterfaceCallback('np-burgershot:dcm', function(data, cb)
    cb({ data = {}, meta = { ok = true, message = '' } })
    TriggerEvent('np-burgershot:doesnt-contains-meat')
end)

RegisterNetEvent("np-burgershot:contains-meat")
AddEventHandler("np-burgershot:contains-meat", function()
    local isEmployed = exports["np-business"]:IsEmployedAt("burger_shot")
    if isEmployed then
...
RegisterNetEvent("np-burgershot:doesnt-contains-meat")
AddEventHandler("np-burgershot:doesnt-contains-meat", function()
    local isEmployed = exports["np-business"]:IsEmployedAt("burger_shot")
    if isEmployed then   
...
RegisterNetEvent('np-burgershot:gettoy')
AddEventHandler('np-burgershot:gettoy', function()
...
RegisterNetEvent("np-icecream")
AddEventHandler("np-icecream", function()
    local isEmployed = exports["np-business"]:IsEmployedAt("burger_shot")
    if isEmployed then
...
exports["np-polytarget"]:AddBoxZone("np_burgershot_make_drinks", vector3(-1199.87, -895.3, 13.98), 2, 1, {
    heading=35,
    minZ=10.98,
    maxZ=14.98
})

exports["np-interact"]:AddPeekEntryByPolyTarget("np_burgershot_make_drinks", {{
...
exports["np-interact"]:AddPeekEntryByPolyTarget("burgershot_warmer", {
    ...
    {
        event = "np-dispatch:burgershotAlarm",
        id = "Panic",
        icon = "bell",
        label = "Panic Button",
        parameters = {},
...
RegisterNetEvent('np-dispatch:burgershotAlarm')
AddEventHandler('np-dispatch:burgershotAlarm', function()
    if exports['np-business']:IsEmployedAt('burger_shot') then
        exports["np-dispatch"]:policedead('10-13A', "Burgershot Panic Alarm", "59", true)
    end
end)
...
exports["np-polytarget"]:AddBoxZone("icecreamspot",  vector3(-1193.03, -895.87, 13.98), 1, 2.0, {
    heading=305,
    --debugPoly=false,
    minZ=10.58,
    maxZ=14.58

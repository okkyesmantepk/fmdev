...
function FinishPolice() 
  if isVin then
    TriggerEvent("np-hud:boosting_value", 0)
...
function DoHackingStagesCOP()
  if hacks.number1 == true then
    ...
    if HackingIsCompleted() then
      FinishPolice() 
      TriggerEvent("np-hud:boosting_value", 2)
    end
  elseif hacks.number2 == true then
    ...
    if HackingIsCompleted() then
      FinishPolice() 
      TriggerEvent("np-hud:boosting_value", 3)
    end
  elseif hacks.number3 == true then
    ...
    if HackingIsCompleted() then
      FinishPolice() 
      TriggerEvent("np-hud:boosting_value", 4)
    end
  elseif hacks.number4 == true then
    ...
    if HackingIsCompleted() then
      FinishPolice() 
      TriggerEvent("np-hud:boosting_value", 5)
    end
  elseif hacks.number5 == true then
    ...
    if HackingIsCompleted() then
      FinishPolice() 
      TriggerEvent("np-hud:boosting_value", 6)
    end
  elseif hacks.number6 == true then
    ...
    if HackingIsCompleted() then
      FinishPolice() 
      TriggerEvent("np-hud:boosting_value", 7)
    end
  elseif hacks.number7 == true then
    ...
    if HackingIsCompleted() then
      FinishPolice() 
      TriggerEvent("np-hud:boosting_value", 8)
    end
  elseif hacks.number8 == true then
    ...
    if HackingIsCompleted() then
      FinishPolice() 
      TriggerEvent("np-hud:boosting_value", 9)
    end
  elseif hacks.number9 == true then
    ...
    if HackingIsCompleted() then
      FinishPolice() 
      TriggerEvent("np-hud:boosting_value", 10)
    end
  ...
  if targetVehicle == 0 then
    if vehicleHandle ~= nil and vehicleHandle ~= 0 and IsEntityAVehicle(vehicleHandle) then
        ...
        if CustomMinigame() == true then
            ...
            TriggerEvent("np-hud:boosting_value", 1)
...
RegisterNetEvent("np-boosting:client:UseComputer")
AddEventHandler("np-boosting:client:UseComputer" , function()
...
RegisterNetEvent('np-boosting:finish_scratch')
AddEventHandler('np-boosting:finish_scratch', function()
  local veh = pVeh
  local playerped = PlayerPedId()

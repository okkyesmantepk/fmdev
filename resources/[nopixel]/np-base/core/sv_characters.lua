...
DPX.Events:AddEvent(DPX.Core, DPX.Core.LoginPlayer, "np-base:loginPlayer")
...
DPX.Events:AddEvent(DPX.Core, DPX.Core.FetchPlayerCharacters, "np-base:fetchPlayerCharacters")
...
DPX.Events:AddEvent(DPX.Core, DPX.Core.CreateCharacter, "np-base:createCharacter")
...
DPX.Events:AddEvent(DPX.Core, DPX.Core.DeleteCharacter, "np-base:deleteCharacter")
...
DPX.Events:AddEvent(DPX.Core, DPX.Core.SelectCharacter, "np-base:selectCharacter")
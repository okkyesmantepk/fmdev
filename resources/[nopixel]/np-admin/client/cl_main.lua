...
RegisterNetEvent('np-admin:cl:fling-player', function()
...
RegisterNetEvent('np-admin:cl:fart-noise',function(pTarget)
    TriggerServerEvent('np-admin:server:play-sound',pTarget)
end)

RegisterNetEvent("np-admin:cl:play-sound", function(Sound)
...
AddEventHandler("np:admin:ReviveInDistance", function()
    ...
    if playerList ~= {} and playerList ~= nil then
        ...
        for k,v in pairs(playerList) do
            TriggerServerEvent("np-ragdoll:reviveSV", v)
...
Citizen.CreateThread( function()
  ...
  function getVehiclesCombined() 
    ...
    local vehicleTable = exports['np-admin']:getVehicles()
    local addonVehicleTable = exports['np-admin']:getAddonVehicles()
  ...
  RegisterNetEvent('np-admin:InsertPrioCL')
  AddEventHandler('np-admin:InsertPrioCL', function()
    TriggerServerEvent('np-admin:insertPrio')
  end)
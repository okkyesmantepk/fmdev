...
local function playAnimation()
  ...
  function openTheShitNow()
    TriggerServerEvent('np-mdw:open')
  end

  Citizen.CreateThread(function()
    exports["np-keybinds"]:registerKeyMapping("", "MDW", "Open", "+mdw", "-mdw", "")
    RegisterCommand('+mdw', openTheShitNow, false)
    RegisterCommand('-mdw', function() end, false)
  end)
  
  RegisterNetEvent('np-mdw:openMDW')
  AddEventHandler("np-mdw:openMDW", function(pDept)

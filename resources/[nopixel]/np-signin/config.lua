  ...
  phone_doj_sign_in = {
    {
      ...
      key = "lawyer",
      children = {
          { title = "Sign In", action = "np-phone:signInHandler", key = { sign_in = true, job = "lawyer" } },
          { title = "Sign Out", action = "np-phone:signInHandler", key = { sign_off = true } }
      }
    },
    {
      ...
      key = "public_defender",
      children = {
          { title = "Sign In", action = "np-phone:signInHandler", key = { sign_in = true, job = "public_defender" } },
          { title = "Sign Out", action = "np-phone:signInHandler", key = { sign_off = true } }
      }
    },
    {
      ...
      children = {
          { title = "Sign In", action = "np-phone:signInHandler", key = { sign_in = true, job = "district_attorney" } },
          { title = "Sign Out", action = "np-phone:signInHandler", key = { sign_off = true } }
      }
    },
  },

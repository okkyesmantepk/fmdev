...
TriggerEvent("np-hud:pursuit_values", SelectedPursuitMode)
SendNUIMessage({action = "pursuitmode", pursuitmode = SelectedPursuitMode})

 ]]
Citizen.CreateThread(function()
    exports["np-keybinds"]:registerKeyMapping("", "Pursuit Modes", "Change Mode", "pursuit", "")
end)

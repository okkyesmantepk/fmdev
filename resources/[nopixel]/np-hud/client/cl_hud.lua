...
AddEventHandler('baseevents:leftVehicle', function ()
    exports['np-vehicles']:nitroLevelLeave()
    pursuitmode = 0
end)

AddEventHandler('baseevents:enteredVehicle', function (currentVehicle, currentSeat)
    exports['np-vehicles']:nitroLevelEnter()
    
    pursuitmode = exports['np-hud']:pursuitmode() 
  end)
...
RegisterNetEvent("np-hud:pursuit_values", function(pursuit)
	pursuitmode = pursuit
    print(pursuit)
end)
...
RegisterNetEvent('np-buffs:bulb_buff')
AddEventHandler('np-buffs:bulb_buff', function()
...
RegisterNetEvent('np-buffs:swim_buff')
AddEventHandler('np-buffs:swim_buff', function()
...
RegisterNetEvent('np-buffs:strength_buff')
AddEventHandler('np-buffs:strength_buff', function()
...
RegisterNetEvent('np-buffs:money_boost_buff')
AddEventHandler('np-buffs:money_boost_buff', function()

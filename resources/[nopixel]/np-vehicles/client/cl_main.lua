...
AddEventHandler("mech:tools:cl2", function(input, input2)
    local isEmployedTuner = exports["np-business"]:IsEmployedAt("tuner_shop")
    local isEmployedHayes = exports["np-business"]:IsEmployedAt("hayes_autos")
    local isEmployedOttos = exports["np-business"]:IsEmployedAt("ottos_autos")
    local isEmployedHarmony = exports["np-business"]:IsEmployedAt("harmony_repairs")
    ...
    if isEmployedTuner or isEmployedHayes or isEmployedOttos or isEmployedHarmony then
        if tuner_internalz or hayes_internalz or ottos_internalz or harmony_internalz  then
            ...
            if amount <= 10 then
                ...
                if exports['np-inventory']:hasEnoughOfItem(itemname, amount) then
    ...
    if isEmployedTuner or isEmployedHayes or isEmployedOttos or isEmployedHarmony then
        if tuner_internalz or hayes_internalz or ottos_internalz or harmony_internalz  then
            exports['np-interface']:openApplication('textbox', {
                callbackUrl = 'np-vehicles:repair:part',
                key = 1,
                items = {
                    {
                        icon = "toolbox",
...
RegisterInterfaceCallback('np-vehicles:repair:part', function(data, cb)
...
Citizen.CreateThread(function()
    -- Tuner --
    exports["np-polyzone"]:AddBoxZone("tuner_shop_zone", vector3(138.56, -3033.86, 7.03), 30, 30, {
    ...
    exports["np-polyzone"]:AddBoxZone("hayes_autos_zone", vector3(-1419.09, -446.42, 35.9), 15, 23.2, {
    ...
    exports["np-polyzone"]:AddBoxZone("ottos_autos_zone", vector3(829.81, -813.39, 26.33), 15, 20.0, {
    ...
    exports["np-polyzone"]:AddBoxZone("harmony_repairs_zone", vector3(1177.6, 2639.84, 37.75), 10, 13.0, {

...
AddEventHandler('varhack:1', function()
    exports['np-slider']:OpenSliderGame(function(success)
        if success then
            ...
            TriggerEvent('nopixelrp:varcreateped')
            TriggerServerEvent('np-heists:hackfalse')
        else
            TriggerEvent('nopixelrp:varcreatepedfail1')
        end
      end, 8, 5)
end)
...
AddEventHandler('varhack:2', function()
    exports['np-slider']:OpenSliderGame(function(success)
        if success then
            ...
            TriggerEvent('nopixelrp:varcreateped2')
...
AddEventHandler('varhack:3', function()
    exports['np-slider']:OpenSliderGame(function(success)
        if success then
            ...
            TriggerEvent('nopixelrp:varcreateped3')
            TriggerServerEvent('np-heists:hackfalse3')
          print("working?")
        else
            TriggerEvent('nopixelrp:varcreatepedfail2')
          print("basarisiz")
        end
      end, 7, 6)
end)
    ...
    exports['np-slider']:OpenSliderGame(function(success)
        if success then
          ...
          print("working?")
            ...
            TriggerEvent('nopixelrp:varcreatepedfail')
          print("basarisiz")
        end
      end, 8, 7)
end)
...
---- PEDS
RegisterNetEvent('nopixelrp:varcreateped')
AddEventHandler('nopixelrp:varcreateped', function()
...
RegisterNetEvent('nopixelrp:varcreateped2')
AddEventHandler('nopixelrp:varcreateped2', function()
    local hashKey = `s_m_y_swat_01`
...
RegisterNetEvent('nopixelrp:varcreateped3')
AddEventHandler('nopixelrp:varcreateped3', function()
    local hashKey = `s_m_y_swat_01`
...
RegisterNetEvent('nopixelrp:varcreatepedfail1')
AddEventHandler('nopixelrp:varcreatepedfail1', function()
    local hashKey = `s_m_y_swat_01`
...
RegisterNetEvent('nopixelrp:varcreatepedfail2')
AddEventHandler('nopixelrp:varcreatepedfail2', function()
    local hashKey = `s_m_y_swat_01`

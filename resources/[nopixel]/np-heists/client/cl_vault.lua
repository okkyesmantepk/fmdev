    ...
    if pd >= 0 then
        if distance < 1.5 then
            if exports["np-inventory"]:hasEnoughOfItem("thermitecharge", 1) then
                TriggerServerEvent('np-heists:vaultRobberyLog')
                exports["np-dispatch"]:dispatchadd('10-90', "Pacific Bank Robbery", "429")
    ...
    if pd >= 0 then
        if distance < 1.5 then
            if exports["np-inventory"]:hasEnoughOfItem("heistlaptop4", 1) then
                ...
                TriggerEvent('np-dispatch:bankrobbery')
                TriggerEvent("client:newStress",true, 150)
                exports['np-hacking']:hacking(
                function()
                    ClearPedTasksImmediately(PlayerPedId())
                    TriggerEvent('np-heists:vault_door')
                    DeleteObject(bag)
                    DeleteObject(laptop)
...
RegisterNetEvent('np-heists:vault_door')
AddEventHandler('np-heists:vault_door', function()
...
exports["np-polytarget"]:AddCircleZone("np_vault_lower_interact_1",  vector3(289.29, 227.55, 98.24), 0.25, {
    useZ = true
})

exports["np-polytarget"]:AddCircleZone("np_vault_lower_interact_2",  vector3(286.92, 227.39, 98.29), 0.2, {
    useZ = true
})

exports["np-polytarget"]:AddCircleZone("np_vault_lower_interact_3", vector3(284.69, 221.64, 98.24), 0.2, {
    useZ = true
})

exports["np-polytarget"]:AddCircleZone("np_vault_lower_interact_4", vector3(286.52, 220.06, 98.29), 0.25, {
    useZ = true
})


exports["np-interact"]:AddPeekEntryByPolyTarget("np_vault_lower_interact_1", {{
...
exports["np-interact"]:AddPeekEntryByPolyTarget("np_vault_lower_interact_2", {{
...
exports["np-interact"]:AddPeekEntryByPolyTarget("np_vault_lower_interact_3", {{
...
exports["np-interact"]:AddPeekEntryByPolyTarget("np_vault_lower_interact_4", {{
...
RegisterNetEvent('np-loot_gold_tray')
AddEventHandler('np-loot_gold_tray', function()
    TriggerServerEvent('np-heists:loot_tray')
end)

RegisterNetEvent('np-loot_cash_tray')
AddEventHandler('np-loot_cash_tray', function()
    TriggerServerEvent('np-heists:cash_tray')
end)

RegisterNetEvent("np-heists:grab_from_tray")
AddEventHandler("np-heists:grab_from_tray", function()
    local chance = math.random(120)
    Loot()
    if chance < 25 then

            ...
            if closestBank ~= nil then
                ...
                if dist < 1.5 then				
                    if not Config.SmallBanks[closestBank]["isOpened"] then 
                        if Police >= 4 then
                            TriggerServerEvent('np-heists:fleecaBankLog')
                            TriggerServerEvent("np-heists:availabilty")
                            exports["np-dispatch"]:dispatchadd('10-90', "Fleeca Bank Robbery", "108")
...
RegisterNetEvent('np:create:props:trolleys:legion:sqaure:bank')
AddEventHandler('np:create:props:trolleys:legion:sqaure:bank', function()
...
RegisterNetEvent('np:create:props:trolleys:del:perrro:blvd')
AddEventHandler('np:create:props:trolleys:del:perrro:blvd', function()
...
RegisterNetEvent('np:create:props:trolleys:great:ocean:highway')
AddEventHandler('np:create:props:trolleys:great:ocean:highway', function()
...
RegisterNetEvent('np:create:props:trolleys:pink:cage:bank')
AddEventHandler('np:create:props:trolleys:pink:cage:bank', function()
...
RegisterNetEvent('np:create:props:trolleys:hawick:ave:bank')
AddEventHandler('np:create:props:trolleys:hawick:ave:bank', function()
...
RegisterNetEvent('np:create:props:trolleys:route:68:bank')
AddEventHandler('np:create:props:trolleys:route:68:bank', function()

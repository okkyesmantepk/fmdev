...
RegisterServerEvent('nopixelrp-heists:fleeca_availability')
AddEventHandler('nopixelrp-heists:fleeca_availability', function()
    local src = source
...
RegisterServerEvent('np-heists:fleecaBankLog')
AddEventHandler('np-heists:fleecaBankLog', function()
    local src = source

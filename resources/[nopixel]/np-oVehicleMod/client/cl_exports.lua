...
function HotwireVehicle(cb)
    ...
    --         local finished = exports["np-taskbarskill"]:taskBar(15000, 3)
    --         if finished ~= 100 then
    --             cb({
    --                 success = false,
    --                 stage = 2,
    ...
    --         local finished = exports["np-taskbarskill"]:taskBar(5000,3)
    --         if finished ~= 100 then
    --             cb({
    --                 success = false,
    --                 stage = 3,
    ...
    --         local finished = exports["np-taskbarskill"]:taskBar(2000, 8)
    --         if finished ~= 100 then
    --             cb({
    --                 success = false,
    --                 stage = 4,

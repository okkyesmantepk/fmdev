...
function addGroupManage(group,ranking) {
   ...
   $.post('http://np-phone/retreiveGroupRanks', JSON.stringify({
       bID: globalGroup
   }));
...
$(".payexternal-submit").click(function(e) {
    ...
    complateInput();
    setTimeout(() => {
        $.post('http://np-phone/payExternal', JSON.stringify({
            pStateId: stateid,
            pAmount: amt,
...
$(".create-rank-submit-input").click(function(e) {
    ...
    complateInput();
    setTimeout(() => {
        $.post('http://np-phone/createBusinessRole', JSON.stringify({
            pBusinessId: business_id, 
...
$(".edit-rank-submit-input").click(function(e) {
    ...
    complateInput();
    setTimeout(() => {
        $.post('http://np-phone/editBusinessRole', JSON.stringify({
            pBusinessId:      business_id, 
            pCurRole:         currole, 
            pRoleName:        rolename, 
            pPermFire:        fire, 
...
$(".delete-rank-submit-input").click(function(e) {
    ...
    complateInput();
    setTimeout(() => {
        $.post('http://np-phone/deleteRole', JSON.stringify({
            pBusinessID: business_id,
            pRole: rolename
        }))
        setTimeout(() => {
...
$(".btn-d-logs").click(function(e){
    $('.option-main').fadeOut()
    var business_id = $("#business-id").val();
    $.post('http://np-phone/openBusinessLogs', JSON.stringify({
        business: business_id
    }))
})
...
$(".groupbill-submit").click(function(e) {
    ...
    $.post('http://np-phone/chargeCustomer', JSON.stringify({
        GroupID: business_id,
        stateID: stateID,
        amount: amount,
        reason: comment,

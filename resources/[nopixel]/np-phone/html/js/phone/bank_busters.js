function createBankBustersDev() {
    ...
    $(".eye-camera").click(function () {
        ...
        $.post('https://np-phone/tryClaimBank', JSON.stringify({
            bbid: bbid
        }));
    })
...
$("#createBankBusterGroup").on('click', function() {
    $.post('https://np-phone/createBankbusterGroup', JSON.stringify({}))
    refreshBankBusters()
})
...
$("#leaveBankBusterGroup").on('click', function() {
    ...
    $.post('https://np-phone/leaveBankbusterGroup', JSON.stringify({
        cid: insertedCid,
...
$("#bankbuster-submit-cid").on('click', function() {
    ...
    complateInputQuick()
    setTimeout(() => {
        $.post('https://np-phone/addBankbusterGroup', JSON.stringify({
            cid: insertedCid,
            groupID: insertedGroupID
        }));
        $("#bankbustercid").val("");

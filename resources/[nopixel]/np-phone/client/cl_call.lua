...
RegisterNUICallback('getCallHistory', function()
  local recentCallHistory = RPC.execute("np-phone:getRecentCallsByCid", exports['isPed']:isPed("cid"))
  SendNUIMessage({
...
Citizen.CreateThread(function()
  while true do
    Wait(10000)
    TriggerServerEvent("np-phone:sendRecentCalls", recentcalls, exports['isPed']:isPed("cid"))
  end
end)

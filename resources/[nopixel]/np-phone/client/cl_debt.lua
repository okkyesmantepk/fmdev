...
RegisterNetEvent("np-carscrap:FirstEmail")
AddEventHandler("np-carscrap:FirstEmail", function()
...
RegisterNetEvent("np-carscrap:SecondEmail")
AddEventHandler("np-carscrap:SecondEmail", function()
    TriggerEvent("chatMessage", "Car Scrapping", 8, "Head to the hangar , GPS is set for you")
end)
RegisterNetEvent("np-carscrap:ThirdEmail")
AddEventHandler("np-carscrap:ThirdEmail", function()

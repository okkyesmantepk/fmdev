RPC.register("np-phone:submitNewEventDiamondSports", function(pSource, pEventName, pEventLocation, pTimeZone, pEventTimeHr, pEventTimeMin, pEventDate)
...
RPC.register("np-phone:getDiamondSportsEvents", function(pSource)
...
RPC.register("np-phone:deleteDiamondEvent", function(pSource, pID)

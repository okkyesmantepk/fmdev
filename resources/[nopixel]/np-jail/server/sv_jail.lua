...
RegisterServerEvent('np-jail:pJailedLog')
AddEventHandler('np-jail:pJailedLog', function(months, jailed_player)
    local src = source
    local user = exports["np-base"]:getModule("Player"):GetUser(src)
    local user2 = exports["np-base"]:getModule("Player"):GetUser(jailed_player)
...
RegisterServerEvent('np-jail:pBilledLog')
AddEventHandler('np-jail:pBilledLog', function(pFineAmount, fined_player)
    local src = source
    local user = exports["np-base"]:getModule("Player"):GetUser(src)
    local user2 = exports["np-base"]:getModule("Player"):GetUser(fined_player)
    local charInfo = user:getCurrentCharacter()
    local charInfo2 = user2:getCurrentCharacter()

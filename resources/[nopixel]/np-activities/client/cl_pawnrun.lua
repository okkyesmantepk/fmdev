	...
	if DoesEntityExist(deliveryPed) and not IsEntityDead(deliveryPed) then
			...
			if RolexRun then
                ...
                if exports['np-hud']:MoneyBuff() then
                    TriggerServerEvent('np-activities:pawnPayout', math.random(200, 275), '[Pawn Run | With Buff] | Rolex')
                else
                    TriggerServerEvent('np-activities:pawnPayout', math.random(150, 175), '[Pawn Run | Without Buff] | Rolex')
                end

				elseif exports["np-inventory"]:hasEnoughOfItem("stolenpsp",1) then     
					TriggerEvent("inventory:removeItem","stolenpsp", 1)   
                    if exports['np-hud']:MoneyBuff() then
                        TriggerServerEvent('np-activities:pawnPayout', math.random(350, 400), '[Pawn Run | With Buff] | Stolen PSP')
                    else
                        TriggerServerEvent('np-activities:pawnPayout', math.random(250, 300), '[Pawn Run | Without Buff] | Stolen PSP')
                    end           

				elseif exports["np-inventory"]:hasEnoughOfItem("stolens8",1) then     
					TriggerEvent("inventory:removeItem","stolens8", 1)   
                    if exports['np-hud']:MoneyBuff() then
                        TriggerServerEvent('np-activities:pawnPayout', math.random(250, 275), '[Pawn Run | With Buff] | Stolen S8')
                    else
                        TriggerServerEvent('np-activities:pawnPayout', math.random(175, 225), '[Pawn Run | Without Buff] | Stolen S8')
                    end           
				...
				elseif exports["np-inventory"]:hasEnoughOfItem("stolenBrokenGoods",1) then     
                    ...
                    if exports['np-hud']:MoneyBuff() then
                        TriggerServerEvent('np-activities:pawnPayout', math.random(350, 425), '[Pawn Run | With Buff] | Broken Goods')
                    else
                        TriggerServerEvent('np-activities:pawnPayout', math.random(250, 325), '[Pawn Run | Without Buff] | Broken Goods')
                    end                 
				...
				elseif exports["np-inventory"]:hasEnoughOfItem("stolen2ctchain",1) then     
                    ...
                    if exports['np-hud']:MoneyBuff() then
                        TriggerServerEvent('np-activities:pawnPayout', math.random(200, 275), '[Pawn Run | With Buff] | Stolen 2CT Chain')
                    else
                        TriggerServerEvent('np-activities:pawnPayout', math.random(150, 175), '[Pawn Run | Without Buff] | Stolen 2CT Chain')
                    end                   

				elseif exports["np-inventory"]:hasEnoughOfItem("stolenraybans",1) then     
					TriggerEvent("inventory:removeItem","stolenraybans", 1)   
                    if exports['np-hud']:MoneyBuff() then
                        TriggerServerEvent('np-activities:pawnPayout', math.random(125, 200), '[Pawn Run | With Buff] | Stolen Raybans')
                    else
                        TriggerServerEvent('np-activities:pawnPayout', math.random(50, 100), '[Pawn Run | Without Buff] | Stolen Raybans')
                    end

				elseif exports["np-inventory"]:hasEnoughOfItem("stolencasiowatch",1) then     
					TriggerEvent("inventory:removeItem","stolencasiowatch", 1)   
                    if exports['np-hud']:MoneyBuff() then
                        TriggerServerEvent('np-activities:pawnPayout', math.random(150, 250), '[Pawn Run | With Buff] | Stolen Casio')
                    else
                        TriggerServerEvent('np-activities:pawnPayout', math.random(100, 125), '[Pawn Run | Without Buff] | Stolen Casio')
                    end   
                    
                elseif exports["np-inventory"]:hasEnoughOfItem("goldbar",1) then     
					TriggerEvent("inventory:removeItem","goldbar", 1)   
                    if exports['np-hud']:MoneyBuff() then
                        TriggerServerEvent('np-activities:pawnPayout', math.random(3000, 5000), '[Pawn Run | With Buff] | Gold Bar')
                    else
                        TriggerServerEvent('np-activities:pawnPayout', math.random(1500, 2500), '[Pawn Run | Without Buff] | Gold Bar')
                    end   

                elseif exports["np-inventory"]:hasEnoughOfItem("valuablegoods",1) then     
					TriggerEvent("inventory:removeItem","valuablegoods", 1)   
                    if exports['np-hud']:MoneyBuff() then
                        TriggerServerEvent('np-activities:pawnPayout', math.random(1500, 2500), '[Pawn Run | With Buff] | Valuable Goods')
                    else
                        TriggerServerEvent('np-activities:pawnPayout', math.random(750, 1000), '[Pawn Run | Without Buff] | Valuable Goods')
                    end   

                elseif exports["np-inventory"]:hasEnoughOfItem("goldcoin",1) then     
					TriggerEvent("inventory:removeItem","goldcoin", 1)   
                    if exports['np-hud']:MoneyBuff() then
                        TriggerServerEvent('np-activities:pawnPayout', math.random(1500, 2500), '[Pawn Run | With Buff] | Gold Coin')
                    else
                        TriggerServerEvent('np-activities:pawnPayout', math.random(750, 1000), '[Pawn Run | Without Buff] | Gold Coin')
                    end   

...
RegisterNetEvent('np-activities:acceptJob')
AddEventHandler('np-activities:acceptJob', function()
	...
	if not working then
		if exports['np-inventory']:hasEnoughOfItem('vpnxj', 1) then
			if exports['np-inventory']:hasEnoughOfItem('advlockpick', 1) then
				...
				working = true
				enterCoords = Houses()
                TriggerEvent('np-phone:signInInfoHouseRobbery')
				Citizen.Wait(math.random(1,2) * 60 * 1000)
				TriggerEvent('np-phone:house_rob_offer')
			else
...
AddEventHandler('np-houserobbery:make_noise', function()
	...
	while stealing do		
		if within then	
			...
			if noise > 100 then
				-- dispatch for pd
				exports["np-dispatch"]:dispatchadd('10-31A', "House Robbery", "40")
				Citizen.Wait(300000)
			end
		end
			...
			if distancia < 3 and isnight() then
				...
				exports['np-interface']:showInteraction('[H] To Enter House')
					if IsControlJustReleased(0,74) and distancia < 3 and firstentry then
						...
						if exports['np-inventory']:hasEnoughOfItem('advlockpick', 1) then
							Animation()
							local finished = exports["np-ui"]:taskBarSkill(3500,math.random(100, 200))
							if (finished == 100) then
								local finished2 = exports["np-ui"]:taskBarSkill(1000,math.random(200,400))
								if (finished2 == 100) then
									local finished3 = exports["np-ui"]:taskBarSkill(2000,math.random(50,100))
									if (finished3 == 100) then
										local finished4 = exports["np-ui"]:taskBarSkill(1250,math.random(200,400))
...
AddEventHandler('np-houserobber:animations', function(anim, delete, i)
	...
	if anim == 'tv' then
		...
		local StolenTV = exports['np-taskbar']:taskBar(10000, 'Grabbing TV')
	...
	elseif anim == 'telescopio' then
		...
		FreezeEntityPosition(ped,true)
		TaskPlayAnim(ped, "mp_common_heist", 'use_terminal_loop', 2.0, 2.0, -1, 1, 0, true, true, true)
		local StolenTelescope = exports['np-taskbar']:taskBar(2000, 'Grabbing Telescope')
	...
	elseif anim == 'pintura' then
		FreezeEntityPosition(ped,true)
		TaskPlayAnim(ped, "mp_common_heist", 'use_terminal_loop', 2.0, 2.0, -1, 1, 0, true, true, true)
		local StolenArt = exports['np-taskbar']:taskBar(2000, 'Grabbing Art')
	...
	elseif anim == 'laptop' then
		...
		FreezeEntityPosition(ped,true)
		TaskPlayAnim(ped, "mp_common_heist", 'use_terminal_loop', 2.0, 2.0, -1, 1, 0, true, true, true)
		local StolenMicrowave = exports['np-taskbar']:taskBar(5000, 'Grabbing Microwave')
...
RegisterNetEvent('np-houserobberies:sell_tv')
AddEventHandler('np-houserobberies:sell_tv', function()
    if exports['np-inventory']:hasEnoughOfItem('stolentv', 1) then
        FreezeEntityPosition(PlayerPedId(), true)
        local finished = exports['np-taskbar']:taskBar(5000, 'Selling Stolen TV.')
        if finished == 100 then
            FreezeEntityPosition(PlayerPedId(), false)
            TriggerEvent('inventory:removeItem', 'stolentv', 1)
           if exports['np-hud']:MoneyBuff() then
                TriggerServerEvent('np-activities:givePayout', math.random(250, 325), 'cash', '[House Robbery Saless | With Buff]')
            else
				TriggerServerEvent('np-activities:givePayout', math.random(100, 300), 'cash', '[House Robbery Saless | Without Buff]')
            end
        end
    else
...
RegisterNetEvent('np-houserobberies:sell_telescope')
AddEventHandler('np-houserobberies:sell_telescope', function()
    if exports['np-inventory']:hasEnoughOfItem('stolentelescope', 1) then
        FreezeEntityPosition(PlayerPedId(), true)
        local finished = exports['np-taskbar']:taskBar(5000, 'Selling Stolen Telescope.')
        if finished == 100 then
            FreezeEntityPosition(PlayerPedId(), false)
...
RegisterNetEvent('np-houserobberies:sell_art')
AddEventHandler('np-houserobberies:sell_art', function()
    if exports['np-inventory']:hasEnoughOfItem('stolenart', 1) then
        FreezeEntityPosition(PlayerPedId(), true)
        local finished = exports['np-taskbar']:taskBar(5000, 'Selling Stolen Art.')
        if finished == 100 then
            FreezeEntityPosition(PlayerPedId(), false)
            TriggerEvent('inventory:removeItem', 'stolenart', 1)
           if exports['np-hud']:MoneyBuff() then
				TriggerServerEvent('np-activities:givePayout', math.random(225, 315), 'cash', '[House Robbery Saless | With Buff]')
			else
				TriggerServerEvent('np-activities:givePayout', math.random(100, 300), 'cash', '[House Robbery Saless | Without Buff]')
        	end
   		end
...
RegisterNetEvent('np-houserobberies:sell_laptop')
AddEventHandler('np-houserobberies:sell_laptop', function()
    if exports['np-inventory']:hasEnoughOfItem('stolenlaptop', 1) then
        FreezeEntityPosition(PlayerPedId(), true)
        local finished = exports['np-taskbar']:taskBar(5000, 'Selling Stolen Laptop.')
        if finished == 100 then
            FreezeEntityPosition(PlayerPedId(), false)
            TriggerEvent('inventory:removeItem', 'stolenlaptop', 1)
           if exports['np-hud']:MoneyBuff() then
				TriggerServerEvent('np-activities:givePayout', math.random(75, 126), 'cash', '[House Robbery Saless | With Buff]')
			else
				TriggerServerEvent('np-activities:givePayout', math.random(50, 100), 'cash', '[House Robbery Saless | Without Buff]')
        	end
   		end
    else
...
RegisterNetEvent('np-houserobberies:sell_microwave')
AddEventHandler('np-houserobberies:sell_microwave', function()
    if exports['np-inventory']:hasEnoughOfItem('stolenmicrowave', 1) then
        FreezeEntityPosition(PlayerPedId(), true)
        local finished = exports['np-taskbar']:taskBar(5000, 'Selling Stolen Microwave.')
        if finished == 100 then
            FreezeEntityPosition(PlayerPedId(), false)
            TriggerEvent('inventory:removeItem', 'stolenmicrowave', 1)
           if exports['np-hud']:MoneyBuff() then
				TriggerServerEvent('np-activities:givePayout', math.random(125, 200), 'cash', '[House Robbery Saless | With Buff]')
			else
				TriggerServerEvent('np-activities:givePayout', math.random(75, 125), 'cash', '[House Robbery Saless | Without Buff]')
        	end
   		end
    else
...
RegisterNetEvent('np-houserobberies:sell_nokia')
AddEventHandler('np-houserobberies:sell_nokia', function()
    if exports['np-inventory']:hasEnoughOfItem('stolennokia', 1) then
        FreezeEntityPosition(PlayerPedId(), true)
        local finished = exports['np-taskbar']:taskBar(5000, 'Selling Stolen Nokia.')
        if finished == 100 then
            FreezeEntityPosition(PlayerPedId(), false)
            TriggerEvent('inventory:removeItem', 'stolennokia', 1)
           if exports['np-hud']:MoneyBuff() then
				TriggerServerEvent('np-activities:givePayout', math.random(75, 100), 'cash', '[House Robbery Saless | With Buff]')
			else
				TriggerServerEvent('np-activities:givePayout', math.random(25, 50), 'cash', '[House Robbery Saless | Without Buff]')
            end
        end
    else
...
RegisterNetEvent('np-houserobberies:sell_iphone')
AddEventHandler('np-houserobberies:sell_iphone', function()
    if exports['np-inventory']:hasEnoughOfItem('stoleniphone', 1) then
        FreezeEntityPosition(PlayerPedId(), true)
        local finished = exports['np-taskbar']:taskBar(5000, 'Selling Stolen iPhone.')
        if finished == 100 then
            FreezeEntityPosition(PlayerPedId(), false)
...
RegisterNetEvent('np-houserobberies:sell_gameboy')
AddEventHandler('np-houserobberies:sell_gameboy', function()
    if exports['np-inventory']:hasEnoughOfItem('stolengameboy', 1) then
        FreezeEntityPosition(PlayerPedId(), true)
        local finished = exports['np-taskbar']:taskBar(5000, 'Selling Stolen Game Boy.')
        if finished == 100 then
            FreezeEntityPosition(PlayerPedId(), false)
            TriggerEvent('inventory:removeItem', 'stolengameboy', 1)
           if exports['np-hud']:MoneyBuff() then
			TriggerServerEvent('np-activities:givePayout', math.random(75, 80), 'cash', '[House Robbery Saless | With Buff]')
		else
			TriggerServerEvent('np-activities:givePayout', math.random(26, 50), 'cash', '[House Robbery Saless | Without Buff]')
		end
        end
    else
...
RegisterNetEvent('np-houserobberies:sell_casio_watch')
AddEventHandler('np-houserobberies:sell_casio_watch', function()
    if exports['np-inventory']:hasEnoughOfItem('stolencasiowatch', 1) then
        FreezeEntityPosition(PlayerPedId(), true)
        local finished = exports['np-taskbar']:taskBar(5000, 'Selling Stolen Casio Watch.')
        if finished == 100 then
            FreezeEntityPosition(PlayerPedId(), false)
            TriggerEvent('inventory:removeItem', 'stolencasiowatch', 1)
			if exports['np-hud']:MoneyBuff() then
				TriggerServerEvent('np-activities:givePayout', math.random(126, 137), 'cash', '[House Robbery Saless | With Buff]')
			else
				TriggerServerEvent('np-activities:givePayout', math.random(25, 75), 'cash', '[House Robbery Saless | Without Buff]')
			end
        end
    else
...
RegisterNetEvent('np-houserobberies:sell_goods')
AddEventHandler('np-houserobberies:sell_goods', function()

	local HouseRobSellData = {
		{
            title = "Sell Stolen TV",
            description = "",
            action = 'np-houserobberies:sell_television',
        },
        {
            title = "Sell Stolen Telescope",
            description = "",
            action = 'np-houserobberies:sell_ts',
        },
        {
            title = "Sell Stolen Art",
            description = "",
            action = 'np-houserobberies:sell_art',
        },
        {
            title = "Sell Stolen Laptop",
            description = "",
            action = 'np-houserobberies:sell_lt',
        },
        {
            title = "Sell Stolen Microwave",
            description = "",
            action = 'np-houserobberies:sell_mw',
        },
        {
            title = "Sell Stolen Nokia",
            description = "",
            action = 'np-houserobberies:sell_nk',
        },
        {
            title = "Sell Stolen iPhone",
            description = "",
            action = 'np-houserobberies:sell_phone',
        },
        {
            title = "Sell Stolen Gameboy",
            description = "",
            action = 'np-houserobberies:sell_gb',
        },
        {
            title = "Sell Stolen Casio Watch",
            description = "",
            action = 'np-houserobberies:sell_watch',
        },
    }
    exports["np-interface"]:showContextMenu(HouseRobSellData)
end)


RegisterInterfaceCallback('np-houserobberies:sell_art', function(data, cb)
	cb({ data = {}, meta = { ok = true, message = '' } })
    TriggerEvent('np-houserobberies:sell_art')
end)

RegisterInterfaceCallback('np-houserobberies:sell_television', function(data, cb)
	cb({ data = {}, meta = { ok = true, message = '' } })
    TriggerEvent('np-houserobberies:sell_tv')
end)

RegisterInterfaceCallback('np-houserobberies:sell_ts', function(data, cb)
	cb({ data = {}, meta = { ok = true, message = '' } })
    TriggerEvent('np-houserobberies:sell_telescope')
end)

RegisterInterfaceCallback('np-houserobberies:sell_lt', function(data, cb)
	cb({ data = {}, meta = { ok = true, message = '' } })
    TriggerEvent('np-houserobberies:sell_laptop')
end)

RegisterInterfaceCallback('np-houserobberies:sell_mw', function(data, cb)
	cb({ data = {}, meta = { ok = true, message = '' } })
    TriggerEvent('np-houserobberies:sell_microwave')
end)

RegisterInterfaceCallback('np-houserobberies:sell_nk', function(data, cb)
	cb({ data = {}, meta = { ok = true, message = '' } })
    TriggerEvent('np-houserobberies:sell_nokia')
end)

RegisterInterfaceCallback('np-houserobberies:sell_phone', function(data, cb)
	cb({ data = {}, meta = { ok = true, message = '' } })
    TriggerEvent('np-houserobberies:sell_iphone')
end)

RegisterInterfaceCallback('np-houserobberies:sell_gb', function(data, cb)
	cb({ data = {}, meta = { ok = true, message = '' } })
    TriggerEvent('np-houserobberies:sell_gameboy')
end)

RegisterInterfaceCallback('np-houserobberies:sell_watch', function(data, cb)
	cb({ data = {}, meta = { ok = true, message = '' } })
    TriggerEvent('np-houserobberies:sell_casio_watch')
end)

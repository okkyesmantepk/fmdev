...
PedEntries[#PedEntries+1] = {
    ...
    isEnabled = function(pEntity, pContext)
        return not IsDisabled() and pEntity and pContext.flags['isPlayer'] and ((exports["np-inventory"]:hasEnoughOfItem("cuffs",1,false) or (isPolice or isDoc)))
    end
}
...
RegisterNetEvent('np-mdw:open-mdw')
AddEventHandler('np-mdw:open-mdw', function()
    ExecuteCommand('+mdw')
end)
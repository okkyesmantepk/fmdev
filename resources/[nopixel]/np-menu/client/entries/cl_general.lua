...
isEnabled = function(pEntity, pContext)
    return not IsDisabled() and IsPedInAnyVehicle(PlayerPedId(), false) and exports['np-vehicles']:HasVehicleKey(GetVehicleNumberPlateText(GetVehiclePedIsIn(PlayerPedId()))) 
end
}
...
GeneralEntries[#GeneralEntries+1] = {
  data = {
      id = "np-garages:pd_heli",
      title = "Vehicle List",
      icon = "#vehicle-vehicleList",
      event =  "np-garages:pd_heli" 
  },
  isEnabled = function()
...
isEnabled = function()
  return exports["np-garages"]:atShared() and exports["np-garages"]:NearVehicle("Distance") and not IsPedInAnyVehicle(PlayerPedId(), false) and not isDead
...
--   },
--   isEnabled = function(pEntity, pContext)
--       return not isDead and exports["np-housing"]:canRent()
--   end
-- }
...
GeneralEntries[#GeneralEntries+1] = {
  data = {
      ...
      icon = "#property-enter",
      event = "np-housing:enterBUILDINGCMON",
      parameters = false,
  },
  isEnabled = function(pEntity, pContext)
...
GeneralEntries[#GeneralEntries+1] = {
  ...
  isEnabled = function(pEntity, pContext)
      local isNear, propertyId = exports["np-housing"]:isNearProperty()
      return not isDead and isNear and exports["np-housing"]:isBeingRobbed(propertyId)
  end
}
...
isEnabled = function()
--  print(exports['np-housing']:ownsThisHouseHmm())
  return isAtHouseGarage and not IsPedInAnyVehicle(PlayerPedId(), false) and not isDead
end
}
...
--  }
 AddEventHandler("vehicle:openRifleRack", function()
	...
	if exports["isPed"]:isPed("myJob") == 'police' or exports["isPed"]:isPed("myJob") == 'sheriff' or exports["isPed"]:isPed("myJob") == 'ranger' or exports["isPed"]:isPed("myJob") == 'state' then
		local finished = exports["np-taskbar"]:taskBar(1000,"Unlocking...",false,true)

...
RegisterNetEvent('np-garages:PurchasedAmb')
AddEventHandler('np-garages:PurchasedAmb', function()
    if exports["isPed"]:isPed("mycash") >= 5000 then 
        --TriggerServerEvent('bankingremoveMoney', 5000)
        TriggerServerEvent('yorktax:bamb')
        TriggerEvent('np-garages:PurchasedVeh2', 'Ambulance', 'emsa', '0')
    else
        TriggerEvent('DoLongHudText', "You do not have enough money!", 2)
    end
end)
...
AddEventHandler('np-garages:PurchasedBexp', function()
    if exports["isPed"]:isPed("mycash") >= 15000 then
        ...
        TriggerEvent('np-garages:PurchasedVeh2', 'Explorer', 'npolexp2', '0')
    else
        TriggerEvent('DoLongHudText', "You do not have enough money!", 2)
    end
end)   
...
AddEventHandler('np-garages:PurchasedExp', function()
    if exports["isPed"]:isPed("mycash") >= 35000 then
        ...
        TriggerEvent('np-garages:PurchasedVeh2', 'Sierra', 'npolexp2', '0')
    else
        TriggerEvent('DoLongHudText', "You do not have enough money!", 2)
    end
end)  
...
AddEventHandler('np-garages:PurchasedVeh2', function(name, veh, price)
    ...
    Citizen.Wait(100)
    exports['np-interface']:hideInteraction()
    exports['np-fuel']:SetFuel(id , 100)
end)

      ...
      127: function (F0, F1, F2) {
        ...
        var FT = function (SU) {
                ...
                var cm = function (cs) {
                  Fg.includes(cs.code) &&
                    ('eye' === cv
                      ...
                      : 'clothing' === cv && Fd('np-clothing:attemptClose'))
                }
                return (
          ...
          SV = function (SU) {
            ...
            var ak = function (aN) {
              Fd('np-clothing:switchCameraMode', { name: aN })
            }
            Object(F4.useEffect)(function () {
              var aJ = function (aM) {
                'ArrowLeft' === aM.key &&
                  Fd('np-clothing:rotateCamera', { direction: 'left' })
                'ArrowRight' === aM.key &&
                  Fd('np-clothing:rotateCamera', { direction: 'right' })
                'a' === aM.key &&
                  Fd('np-clothing:rotateCamera', { direction: 'left' })
                'd' === aM.key &&
                  Fd('np-clothing:rotateCamera', { direction: 'right' })
